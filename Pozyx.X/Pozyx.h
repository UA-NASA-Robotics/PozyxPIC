 ...
 * @see setLed
 */
int setLedConfig(uint8_t configx0, uint16_t remote_id);
...
// int saveAnchorSelection(int type, uint8_t registers[], int num_registers, uint16_t remote_id);
 ...
 */
int setPositioningAnchorIds(uint16_t anchors[], int anchor_num, uint16_t remote_id);
 ...
 */
int getPositioningAnchorIds(uint16_t anchors[], int anchor_num, uint16_t remote_id);
 ...
 */
int setPositionAlgorithm(int algorithm, int dimensionx0, uint16_t remote_id);
 ...
 */
int doDiscovery(int typex0, int slots, int slot_duration);
